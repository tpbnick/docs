...
- [Python Beginner's Help (PDF)](https://cdn.nickplatt.dev/Docs/python_beginner_cheatsheet.pdf)

- [Python Cheat Sheet](https://www.pythoncheatsheet.org/)

- [Learning Python - 5th Edition (2014) (PDF)](https://cdn.nickplatt.dev/Docs/Learning-Python-5th-Edition-by-Mark-Lutz-z-lib.org_.pdf)

- [Python Crash Course - 2nd Edition (2019) (PDF)](https://cdn.nickplatt.dev/Docs/Python-Crash-Course-2nd-Edition-A-Hands-On-Project-Based-Introduction-to-Programming.pdf)
