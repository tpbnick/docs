...
For the following exercises we will be using new tables.  We will use a table which stores fictional data about [**Employees**](https://nicklyss.com/wp-content/uploads/2020/08/Employees.csv) in the film studio and their assigned office [**Buildings**](https://nicklyss.com/wp-content/uploads/2020/08/Buildings.csv).  Some of the buildings are new, so they don't have any employees in them yet, but we need to find some information about them regardless.  
...
AND/OR ...;
```
For the following exercises, we will be using the same [**Employees**](https://nicklyss.com/wp-content/uploads/2020/08/Employees.csv) and  [**Buildings**](https://nicklyss.com/wp-content/uploads/2020/08/Buildings.csv) tables from the last exercises.  
...
```
We are now going to use expressions to transform the `BoxOffice` data into something easier to understand for the tasks below.  We will use the [Movies.csv](https://nicklyss.com/wp-content/uploads/2020/07/Movies.csv) and [Boxoffice.csv](https://nicklyss.com/wp-content/uploads/2020/07/Boxoffice.csv) files for the following exercise:
